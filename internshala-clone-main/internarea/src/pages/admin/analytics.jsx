...
export default function AdminAnalyticsPage() {
  return (
    <ProtectedAdminRoute>
      <Head>
        <title>Analytics | Admin | InternArea</title>
        <meta
          name="description"
          content="View reports and platform statistics (admin)"
        />
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[84px] pb-12">
        ...
        <p className="mt-2 text-gray-500">
          View detailed reports and platform statistics. (Placeholder content)
        </p>
        ...
        <section className="mt-8 bg-white rounded-2xl shadow-md border border-gray-100 p-6">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Add charts, KPIs, and downloadable reports here.
          </p>
        </section>
      </div>
    </ProtectedAdminRoute>
