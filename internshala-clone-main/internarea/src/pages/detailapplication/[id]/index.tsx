            ...
            <div className="p-8">
              <div className="mb-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-sm font-medium text-gray-500">{t("detailApplicationCompany")}</h2>
                </div>
              ...
              <div className="mb-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-sm font-medium text-gray-500">
                    {t("detailApplicationCoverLetter")}
                  </h2>
                </div>
