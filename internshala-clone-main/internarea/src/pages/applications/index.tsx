...
const index = () => {
  ...
  const handleacceptandreject = async (id: any, action: any) => {
    try {
      ...
      toast.success(t("applicationsUpdatedSuccessfully"));
    } catch (error) {
      console.log(error);
      toast.error(t("applicationsErrorUpdating"));
    }
  };
  return (
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    {t("applicationsCompanyCategory")}
                  </th>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {t("applicationsApplicant")}
                  </th>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                  >
                    {t("applicationsAppliedDate")}
                  </th>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
